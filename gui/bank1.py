...
def cus_reg(n):
    ...
    B.place(relx=0.40,rely=0.70)
    d=Button(frame,text="Back",font=Label_font,bg="red",command=lambda:Home())
...
def Home():
    ...
    Label_font=font.Font(weight="bold",family="Times New Roman",size=20)
    B=Button(n,text="CUSTOMER LOGIN",font=Label_font,bg="lightblue",command=lambda:cus_log(n))
